 ...
 */
final class Version20230927090124 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE bill (id INT AUTO_INCREMENT NOT NULL, paiment_id INT DEFAULT NULL, billuser_id INT DEFAULT NULL, bill_number VARCHAR(255) NOT NULL, INDEX IDX_7A2119E378789290 (paiment_id), INDEX IDX_7A2119E349DC7A00 (billuser_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `key` (id INT AUTO_INCREMENT NOT NULL, key_product_id INT NOT NULL, bill_key_id INT DEFAULT NULL, key_number VARCHAR(191) NOT NULL, INDEX IDX_8A90ABA9F52938E5 (key_product_id), INDEX IDX_8A90ABA91A951B25 (bill_key_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(191) NOT NULL, quantity INT NOT NULL, release_date DATETIME DEFAULT NULL, price DOUBLE PRECISION DEFAULT NULL, description LONGTEXT NOT NULL, rate INT DEFAULT NULL, productcontent LONGTEXT DEFAULT NULL, requiredspecs LONGTEXT DEFAULT NULL, edition VARCHAR(191) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE bill ADD CONSTRAINT FK_7A2119E349DC7A00 FOREIGN KEY (billuser_id) REFERENCES user (id)');
        ...
        $this->addSql('ALTER TABLE `key` ADD CONSTRAINT FK_8A90ABA9F52938E5 FOREIGN KEY (key_product_id) REFERENCES product (id)');
        $this->addSql('ALTER TABLE `key` ADD CONSTRAINT FK_8A90ABA91A951B25 FOREIGN KEY (bill_key_id) REFERENCES bill (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE bill DROP FOREIGN KEY FK_7A2119E349DC7A00');
        ...
        $this->addSql('ALTER TABLE `key` DROP FOREIGN KEY FK_8A90ABA9F52938E5');
        $this->addSql('ALTER TABLE `key` DROP FOREIGN KEY FK_8A90ABA91A951B25');
