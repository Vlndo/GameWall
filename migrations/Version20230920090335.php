 ...
 */
final class Version20230920090335 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE bill (id INT AUTO_INCREMENT NOT NULL, paiment_id INT DEFAULT NULL, user_id INT DEFAULT NULL, bill_number VARCHAR(255) NOT NULL, INDEX IDX_7A2119E378789290 (paiment_id), INDEX IDX_7A2119E3A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
